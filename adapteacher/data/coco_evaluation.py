...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _eval_predictions(self, predictions, img_ids=None):
        ...
        if hasattr(self._metadata, "thing_dataset_id_to_contiguous_id"):
            ...
            # print("DEBUG == coco_evaluation.py == _eval_predictions == dataset_id_to_contiguous_id", dataset_id_to_contiguous_id)
            all_contiguous_ids = list(dataset_id_to_contiguous_id.values())
            num_classes = len(all_contiguous_ids)
            assert min(all_contiguous_ids) == 0 and max(all_contiguous_ids) == num_classes - 1

            reverse_id_mapping = {v: k for k, v in dataset_id_to_contiguous_id.items()}
            # print("DEBUG == coco_evaluation.py == _eval_predictions == reverse_id_mapping", reverse_id_mapping)
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        """
        # print("DEBUG == coco_evaluation.py == _derive_coco_results == class_names", class_names)
        ...
        # print("DEBUG == coco_evaluation.py == results", results)
        self._logger.info(
        ...
        # print("DEBUG == coco_evaluation.py == results_per_category_AP50", results_per_category_AP50)
        # tabulate it
