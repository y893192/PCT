...
def parse_rec(filename):
    ...
    for obj in tree.findall("object"):
        ...
        obj_struct["pose"] = pose_node.text if pose_node is not None else "Unspecified"

        truncated_node = obj.find("truncated")
        obj_struct["truncated"] = int(truncated_node.text) if truncated_node is not None else 0

        difficult_node = obj.find("difficult")
        obj_struct["difficult"] = int(difficult_node.text) if difficult_node is not None else 0
